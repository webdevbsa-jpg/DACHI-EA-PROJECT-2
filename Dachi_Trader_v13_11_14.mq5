// Dachi_Trader_v13_11_14.mq5 — Expert Advisor
// Version: 13.11.14
// Clean Core branch: simplified runtime pipeline (F2 + HTF gate).

#property copyright   "Daniel @danieljulyanto"
#property version     "13.11.14"
#property description "Dachi Trader v13.11.14 — Expert Advisor"
...
bool LIC_VerifyOnce(){
    ...
    string body = StringFormat("{\"account_number\":\"%I64u\",\"ea_version\":\"13.11.14\"}", (ulong)account);
...
int OnInit(){
    ...
    Print("==============================================================");
    Print("[INIT] Dachi Trader v13.11.14 | ",_Symbol," ",EnumToString(_Period),
...
void OnDeinit(const int reason){
    ...
    LIC_ClearOverlay();
    Print("[DEINIT] Dachi v13.11.14 removed");
}
...
uint ComputeFilterHash(){
    ...
    h = (h ^ (uint)0x13C00140)             * 16777619;   // logic version marker
    return h;
}
