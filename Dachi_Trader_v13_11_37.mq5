...
void FireBlockedRetestReentry(int dir, datetime t, double price){
    Print("[BRE-FIRE] ",(dir==1?"BUY":"SELL")," after=",g_bre_reason," price=",DoubleToString(price,_Digits));
    SetupTrade(dir,true);
    EAOpen(dir);
    ...
    for(int i=scan;i>=1;i--){
        ...
        if(hard){
            ...
            if(FindBlockedRetestReentryAt(i,sig,bre_reason,bre_t,bre_p)){
                ...
                sc_reentry++;
                double bre_risk=ah[0]*InpSL_Mult;
                vis_sl=(sig==1)?bre_p-bre_risk:bre_p+bre_risk;
                double bre_tp1=ah[0]*InpTP1_Mult;
                double bre_tp2=bre_tp1+ah[0]*InpTP1_to_TP2_Mult;
