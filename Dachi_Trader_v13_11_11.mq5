// Dachi_Trader_v13_11_11.mq5 — Expert Advisor
// Version: 13.11.11
// Clean Core branch: simplified runtime pipeline (F2 + HTF gate).

#property copyright   "Daniel @danieljulyanto"
#property version     "13.11.11"
#property description "Dachi Trader v13.11.11 — Expert Advisor"
...
bool LIC_VerifyOnce(){
    ...
    string body = StringFormat("{\"account_number\":\"%I64u\",\"ea_version\":\"13.11.11\"}", (ulong)account);
...
int OnInit(){
    ...
    Print("==============================================================");
    Print("[INIT] Dachi Trader v13.11.11 | ",_Symbol," ",EnumToString(_Period),
...
void OnDeinit(const int reason){
    ...
    LIC_ClearOverlay();
    Print("[DEINIT] Dachi v13.11.11 removed");
}
...
uint ComputeFilterHash(){
    ...
    h = (h ^ (uint)0x13C00110)             * 16777619;   // logic version marker
    return h;
}
