// Dachi_Trader_v13_11_25.mq5 — Expert Advisor
// Version: 13.11.25
// Clean Core branch: simplified runtime pipeline (F2 + HTF gate).

#property copyright   "Daniel @danieljulyanto"
#property version     "13.11.25"
#property description "Dachi Trader v13.11.25 — Expert Advisor"
...
input ENUM_TIMEFRAMES InpVLine_TF                 = PERIOD_M15;
...
bool LIC_VerifyOnce(){
    ...
    string body = StringFormat("{\"account_number\":\"%I64u\",\"ea_version\":\"13.11.25\"}", (ulong)account);
...
int OnInit(){
    ...
    Print("==============================================================");
    Print("[INIT] Dachi Trader v13.11.25 | ",_Symbol," ",EnumToString(_Period),
...
void OnDeinit(const int reason){
    ...
    LIC_ClearOverlay();
    Print("[DEINIT] Dachi v13.11.25 removed");
}
...
uint ComputeFilterHash(){
    ...
    h = (h ^ (uint)0x13C00250)             * 16777619;   // logic version marker
    return h;
}
